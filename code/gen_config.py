...
#         self.pretrain_gm_path = 'exps/results/generation/09-07-2024-00-13-49/checkpoint_best.pth'
...
import torch
model_path = '/Data/summer24/DreamDiffusion/pretrains/eeg_pretrain/checkpoint.pth'
